				...
				<div class="card">
					<div
						...
						<div class="social-links mt-2">
							<a href="#"><i class="bi bi-telephone-fill"></i></a> <a href="#"><i
						...
						<div class="tab-content pt-2">
							...
							<div class="tab-pane fade profile-edit pt-3" id="profile-edit">
								...
								<form>
									...
									<div class="row mb-3">
										<label for="uId" class="col-md-4 col-lg-3 col-form-label">User
											ID</label>
										<div class="col-md-8 col-lg-9">
									...
									<div class="row mb-3">
										<label for="uName" class="col-md-4 col-lg-3 col-form-label">User
											Name</label>
										<div class="col-md-8 col-lg-9">
									...
									<div class="row mb-3">
										<label for="mobile" class="col-md-4 col-lg-3 col-form-label">Mobile
											No</label>
										<div class="col-md-8 col-lg-9">
