		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Update Vehicles</li>
				</ol>
			</nav>
		</div>
		<%-- End Page Title --%>
				...
				<section>
					<div class="container container-fluid p-3 mt-2 mb-3 shadow">
						<div class="d-flex justify-content-center pb-2 fs-2 fw-bolder">
							Update Vehicle Information</div>
						<form action="/newVehicles" method="POST">

							<div class="mb-3 row">
								<label for="vId" class="col-sm-2 col-form-label">ID
									No</label>
								<div class="col-sm-10">
									<input type="text" readonly class="form-control" id="vId" name="vId" value=${vcl.getvId()}>
								</div>
							</div>
							<div class="mb-3 row">
								<label for="vNo" class="col-sm-2 col-form-label">Vehicle
									No</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="vNo" name="vNo" value=${vcl.getvNo()}>
								</div>
							</div>
							<div class="mb-3 row">
								<label for="model" class="col-sm-2 col-form-label">Vehicle
									Model</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="model" name="model" value=${vcl.getModel()}>
								</div>
							</div>
							<div class="mb-3 row">
								<label for="type" class="col-sm-2 col-form-label">Vehicle
									Type</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="type" name="type" value=${vcl.getType()}>
								</div>
							</div>
							<div class="mb-3 row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="description"
										name="description" value=${vcl.getDescription()}>
								</div>
							</div>
							<div class="mb-3 row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="capasity"
										name="capasity" value=${vcl.getCapasity()}>
								</div>
							</div>
							<div class="mb-3 row">
								...
								<div class="col-sm-10">
									<input type="file" class="form-control" id="vPhoto"
										name="vPhoto" value=${vcl.getvPhoto()}>
								</div>
							</div>
							<div class="mb-3">
								<button class="btn btn-outline-warning float-end">UPDATE</button>
								<br>
							</div>
						</form>
					</div>
